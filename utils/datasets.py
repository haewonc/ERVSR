    ...
    def __getitem__(self, index):
        ...
        if self.is_use_T: # This is False
            ...
            LR_UW_patches, LR_REF_W_patches, LR_REF_T_patches, HR_UW_patches, HR_REF_W_patches =\
                get_patch(LR_UW_patches, LR_REF_W_patches, LR_REF_T_patches, HR_UW_patches, HR_REF_W_patches, is_crop=True, patch_size=self.patch_size, scale=self.scale, flag_HD_in=self.flag_HD_in)
...
class Test_datasets(data.Dataset):
    def __init__(self, config, is_valid=False):
        ...
        ## validataion
        if is_valid is True:
            LR_data_path = config.VAL_LR_data_path
            HR_data_path = config.VAL_HR_data_path
            HR_ref_data_W_path = config.VAL_HR_ref_data_W_path
            HR_ref_data_T_path = config.VAL_HR_ref_data_T_path
        else:
            LR_data_path = config.EVAL_LR_data_path
            HR_data_path = config.EVAL_HR_data_path
            HR_ref_data_W_path = config.EVAL_HR_ref_data_W_path
            HR_ref_data_T_path = config.EVAL_HR_ref_data_T_path
